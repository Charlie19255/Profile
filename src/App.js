...
function Atom(props) {
  const point = useMemo(() => new THREE.EllipseCurve(0, 0, 250, 250, 0, 2 * Math.PI, false, 1).getPoints(100), [])
  return (
    ...
    <group {...props}>
     ...
     <Text
        ...
        anchorY="40px" // default 
      >
        HELLO WORLD
      </Text>
      <Venus position={[0, 0, 0]} rotation={[0, 0, -Math.PI / 7]} speed={2} />
      <Mercury position={[0, 0, 0]} rotation={[0, 0, -Math.PI / 8]} speed={3} />
      <Earth position={[0, 0, 0]} rotation={[0, 0, -Math.PI / 9]} speed={.5} />
      <Mars position={[0, 0, 0]} rotation={[0, 0, -Math.PI / 10]} speed={.4} />
      <Jupiter position={[0, 0, 0]} rotation={[0, 0, -Math.PI / 11]} speed={.3} />
      <Saturn position={[0, 0, 0]} rotation={[0, 0, -Math.PI / 12]} speed={.2} />
      <Uranus position={[0, 0, 0]} rotation={[0, 0, -Math.PI / 13]} speed={.1} />
      <Neptune position={[0, 0, 0]} rotation={[0, 0, -Math.PI / 20]} speed={.08} />
...
function Mercury({ radius = 10, speed = 6, ...props }) {
  const ref = useRef()
  useFrame((state) => {
...
function Saturn({ radius = 300, speed = 6, ...props }) {
  ...
  const points = useMemo(() => new THREE.EllipseCurve(0, 0, 1.5, 2, 0, 2 * Math.PI, false, 1).getPoints(100), [])
  return (
    <group {...props}>
...
function App() {
  ...
  return (
    <>
    <header style={{display:"flex", justifyContent:"right", backgroundColor:"#F9D5CD"}}> <a href="https://github.com/Charlie19255" target="_blank"><img
                className="logo"
                src="https://charlie19255.github.io/Profile/img/project/hero/logo/logo1.webp"
                alt="First logo"
                style={{height:"30px"}}
              /> </a><a href="https://www.linkedin.com/in/charlie-sihaphong/" target="_blank"><img
              className="logo"
    ...
    Hi, my name is Charlie. I’m currently enrolled in a full-stack bootcamp at Learn Academy. It is the first step in pursuing my passion to help advance the future of gaming. It is because Learn Academy will help provide me the I'm mastering programming language fundamentals, so I can grow into writing code for gaming that is out of this world!
        ...
        <Tab tabClassName="TabsSingle" eventKey="Projects" title="Projects">
          <Carousel>
            <CarouselItem>
            <a href="https://github.com/learn-academy-2022-golf/pig-latin-team-renarlie" target="_blank">
              <img 
                className="FirstProject"
                src="https://charlie19255.github.io/Profile/img/project/First.png"
                alt="First slide"
              /></a>
              <Carousel.Caption style={{color:"black",fontSize:"50px",fontFamily: "Ultra"}} >Pig Latin <br></br> React</Carousel.Caption>
            </CarouselItem>

            <CarouselItem>
            <a href="https://github.com/learn-academy-2022-golf/tic-tac-toe-team-mayhem" target="_blank">
              <img 
                className="FirstProject"
                src="https://charlie19255.github.io/Profile/img/project/Second.png"
                alt="Second slide"
              />
              <Carousel.Caption style={{color:"black",fontSize:"50px",fontFamily: "Ultra"}}>Tic Tac Toe<br></br> React</Carousel.Caption>
              </a>
            </CarouselItem>

            <CarouselItem>
            <a href="https://github.com/learn-academy-2022-golf/treasurehunt-Charlie19255" target="_blank">
              <img 
                className="FirstProject"
                src="https://charlie19255.github.io/Profile/img/project/Third.png"
                alt="Third slide"
              />
              <Carousel.Caption style={{color:"black",fontSize:"50px",fontFamily: "Ultra"}}>Treasure Hunt<br></br> React</Carousel.Caption>
              </a>
            </CarouselItem>

            <CarouselItem>
            <a href="https://github.com/learn-academy-2022-golf/text-based-game-team-cast-away-1" target="_blank">
              <img 
                className="FirstProject"
                src="https://charlie19255.github.io/Profile/img/project/Fourth.png"
                alt="Fourth slide"
              />
              <Carousel.Caption style={{color:"white", fontSize:"50px",fontFamily: "Ultra"}}>Text Based Game<br></br> Ruby</Carousel.Caption>
              </a>
            </CarouselItem>
            <CarouselItem>
            <a href="https://github.com/Charlie19255/threejs-practice" target="_blank">
              <img 
                className="FirstProject"
                src="https://charlie19255.github.io/Profile/img/project/Fifth.png"
                alt="Fifth slide"
              />
              <Carousel.Caption style={{color:"white", fontSize:"50px",fontFamily: "Ultra"}}>Car Project <br></br> React</Carousel.Caption>
              </a>
            </CarouselItem>
          </Carousel>
        </Tab>
        <Tab tabClassName="TabsSingle" eventKey="Contact Me" title="Contact Me" style={{backgroundColor:"#AEC5F4"}}>
          <div style={{display:"flex",  justifyContent:"center"}}>
        <a href="https://github.com/Charlie19255" target="_blank"><img
                className="logo"
                src="https://charlie19255.github.io/Profile/img/project/hero/logo/logo1.webp"
                alt="First logo"
                style={{width:"100px"}}
            ...
            /></a></div><div style={{display:"flex", justifyContent:"center",
            textAlign:"center", fontSize:"20px", fontFamily: "Ultra"}}>
            Email:
            charlie19255@gmail.com</div>
        </Tab>
      </Tabs>
    </>
  );
